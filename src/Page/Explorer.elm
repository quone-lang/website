...
darkTokens =
    { comment = Element.rgb255 0x6B 0x72 0x80
    , keyword = Element.rgb255 0xFF 0x8B 0x7A
    , ty = Element.rgb255 0x5E 0xEA 0xD4
    , str = Element.rgb255 0xF5 0xD2 0x8A
    , num = Element.rgb255 0xC4 0xA3 0xFF
    , op = Element.rgb255 0xFF 0x8B 0x7A
    , fn = Element.rgb255 0x7E 0xB6 0xFF
    }
